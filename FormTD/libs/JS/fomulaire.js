...
function AjouterSelec()
{
    ...
    if ($("#SE").val() === 'Windows')
    {
        $("#version").append("<option name=\"xp\" value=\"XP\">XP</option>");
        $("#version").append("<option name=\"vista\" value=\"Vista\">Vista</option>");
        $("#version").append("<option name=\"seven\" value=\"Seven\">Seven</option>");
    }
